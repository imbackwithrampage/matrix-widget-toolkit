...
/**
 * Props for the {@link SemanticUiCapabilitiesGuard} component.
 */
 ...
 * instead.
 * @param param0 - {@link SemanticUiCapabilitiesGuardProps}
 */
export function SemanticUiCapabilitiesGuard({
  capabilities,
  children,
}: SemanticUiCapabilitiesGuardProps): ReactElement {
  return (
    <CapabilitiesGuard
