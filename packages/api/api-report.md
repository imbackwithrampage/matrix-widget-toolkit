## API Report File for "@beeper/matrix-widget-toolkit-api"
...
import { IRoomAccountData } from '@beeper/matrix-widget-api';
...
export type WidgetApi = {
    ...
    receiveRoomAccountData<T>(eventType: string, options?: {
        roomIds?: string[] | Symbols.AnyRoom;
...
export class WidgetApiImpl implements WidgetApi {
    ...
    // (undocumented)
    receiveRoomAccountData<T>(eventType: string, { roomIds }?: {
        roomIds?: string[] | Symbols.AnyRoom;
    }): Promise<Array<RoomAccountData<T>>>;
    // (undocumented)
    receiveRoomEvents<T>(eventType: string, { messageType, limit, roomIds, since, }?: {
        messageType?: string;
...
//
// lib/src/api/types.d.ts:262:5 - (ae-forgotten-export) The symbol "RoomAccountData" needs to be exported by the entry point index.d.ts
